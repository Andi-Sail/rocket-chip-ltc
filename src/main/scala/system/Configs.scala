...
class LTCConfig_W32F16_small  extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=32,f=16,N_PEs=1)))
class LTCConfig_W32F16_medium extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=32,f=16,N_PEs=2)))
class LTCConfig_W32F16_large  extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=32,f=16,N_PEs=4)))
class LTCConfig_W32F16_huge  extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=32,f=16,N_PEs=16)))

class LTCConfig_W16F8_small  extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=16,f=8,N_PEs=1)))
class LTCConfig_W16F8_medium extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=16,f=8,N_PEs=2)))
class LTCConfig_W16F8_large  extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=16,f=8,N_PEs=4)))
class LTCConfig_W16F8_huge  extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=16,f=8,N_PEs=16)))

class LTCConfig_LargeMem_W32F16_small  extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=32,f=16,N_PEs=1, ramBlockArrdWidth=16, maxNeurons=2048)))
class LTCConfig_LargeMem_W32F16_medium extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=32,f=16,N_PEs=2, ramBlockArrdWidth=16, maxNeurons=2048)))
class LTCConfig_LargeMem_W32F16_large  extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=32,f=16,N_PEs=4, ramBlockArrdWidth=16, maxNeurons=2048)))
class LTCConfig_LargeMem_W32F16_huge  extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=32,f=16,N_PEs=16, ramBlockArrdWidth=16, maxNeurons=2048)))

class LTCConfig_LargeMem_W16F8_small  extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=16,f=8,N_PEs=1, ramBlockArrdWidth=16, maxNeurons=2048)))
class LTCConfig_LargeMem_W16F8_medium extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=16,f=8,N_PEs=2, ramBlockArrdWidth=16, maxNeurons=2048)))
class LTCConfig_LargeMem_W16F8_large  extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=16,f=8,N_PEs=4, ramBlockArrdWidth=16, maxNeurons=2048)))
class LTCConfig_LargeMem_W16F8_huge  extends Config(new LTCConfigFPU(new LTCCoprocConfig(w=16,f=8,N_PEs=16, ramBlockArrdWidth=16, maxNeurons=2048)))
